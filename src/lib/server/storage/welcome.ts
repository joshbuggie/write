...
Your notes are plain \`.md\` files in your data folder: one folder per notebook, one file per note, and the title is the file name. Edit them with any other app, sync them, or put them in git.
