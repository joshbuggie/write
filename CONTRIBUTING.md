...
| `oversized.ts`                                  | The pre-parse check for notes and pastes (`hasOversizedParagraph`): one linear pass over the lines that bounds the longest inline run and guards nesting depth; `fidelity.ts` re-exports it.                                                                                                                                                                   |
